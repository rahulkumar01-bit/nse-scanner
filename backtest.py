...
MAX_HOLDING_DAYS = 20        # time-based exit if neither target nor stop hits within this many trading days
FILL_WINDOW_DAYS = 5         # how long to wait for a proposed pullback entry to actually get touched
